...
import { propertyindex as property } from '../tt/property/propertyindex';
import { listindex as list } from '../tt/list/listindex';
import { util } from '../tt/util';


export function TtNode() {
...
TtNode.prototype = {
    ...
    setupAttribute: function (name, value) {
        ...
        switch (core.getType(value)) {
            case 'function':
                ...
                property.createCalculatedProperty(this, name, calc, 'settergetter');
                // subscribe
    ...
    setCss: function (css) {
        ...
        if (typeof this.initalClassList !== 'undefined') {
            this.domNode.className = this.initalClassList;
        } else {
            this.initalClassList = this.domNode.className;
        }
